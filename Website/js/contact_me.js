  ...
  $("#contactForm input,#contactForm textarea").jqBootstrapValidation({
    ...
    submitSuccess: function($form, event) {
      ...
      grecaptcha.ready(function() {
        grecaptcha.execute('6LeORrAZAAAAAAi7EiSqO8asrSzL5u5tWVmlApO6', {action: 'submit'}).then(function(token) {
          var url = "https://cors-anywhere.herokuapp.com/"
            + "https://recaptchaverifysparkssolutions.azurewebsites.net/api/Verify?recaptchaToken=" 
            + token;
